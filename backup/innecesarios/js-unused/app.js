...
const App = {
     ...
     */
    displayTeams(teams) {
        // Guardar equipos para uso posterior
        this.currentTeams = teams;
        
        // Mostrar resumen compacto y botón para ver equipos
        UI.elements.teamsContainer.innerHTML = `
            <div class="unified-card teams-summary-card">
                <div style="text-align: center; padding: var(--spacing-lg);">
                    <h3 style="color: var(--primary); margin-bottom: var(--spacing-md); display: flex; align-items: center; justify-content: center; gap: 10px;">
                        ⚽ Equipos Generados
                    </h3>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr auto 1fr; gap: var(--spacing-md); align-items: center; margin-bottom: var(--spacing-lg);">
                        <div class="team-summary">
                            <div style="font-size: var(--font-size-lg); font-weight: var(--font-weight-bold); color: var(--text-primary);">Equipo A</div>
                            <div style="font-size: var(--font-size-xl); font-weight: var(--font-weight-black); color: var(--primary);">${teams.teamA.ovr} OVR</div>
                            <div style="font-size: var(--font-size-sm); color: var(--text-secondary);">${teams.teamA.players.length} jugadores</div>
                        </div>
                        
                        <div style="font-size: var(--font-size-xxl); font-weight: var(--font-weight-bold); color: var(--secondary);">VS</div>
                        
                        <div class="team-summary">
                            <div style="font-size: var(--font-size-lg); font-weight: var(--font-weight-bold); color: var(--text-primary);">Equipo B</div>
                            <div style="font-size: var(--font-size-xl); font-weight: var(--font-weight-black); color: var(--primary);">${teams.teamB.ovr} OVR</div>
                            <div style="font-size: var(--font-size-sm); color: var(--text-secondary);">${teams.teamB.players.length} jugadores</div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(0, 255, 157, 0.1); border: 1px solid var(--primary); border-radius: var(--radius-md); padding: var(--spacing-sm); margin-bottom: var(--spacing-lg);">
                        <div style="font-size: var(--font-size-sm); color: var(--primary);">
                            ⚖️ Diferencia OVR: ${teams.difference.toFixed(1)} puntos
                        </div>
                    </div>
                    
                    <button class="btn-unified btn-primary" onclick="app.showTeamsModal()" style="font-size: var(--font-size-md); padding: 12px 30px;">
    ...
    /**
     * Muestra el modal unificado con los equipos detallados
     */
    showTeamsModal() {
        ...
        if (window.unifiedTeamsModal) {
            window.unifiedTeamsModal.show(this.currentTeams, {
                title: '⚽ Equipos Detallados',
                format: this.currentTeams.format || '5v5',
                showFormation: true,
                showStats: false,
                showBalance: true
            });
